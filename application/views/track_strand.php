        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="float-left">
                                            <h5 style="text-transform:uppercase">
                                                <strong>TRACK & STRAND</strong>
                                                <br />
                                                <small>
                                                    <!-- <span class="badge badge-purple mb-3">TRACK & STRAND MODULE</span> -->
                                                </small>
                                            </h5>
                                        </div>
                                                ...
                                                <tbody>
                                                    <?php foreach ($data as $row) { ?>
                                                        ...
                                                        <i class="mdi mdi-pencil"></i>Edit
                                                                ...
                                                                <button type="button" class="btn btn-primary waves-effect waves-light btn-sm" onclick="editTrackStrand('<?= $row->trackID; ?>', '<?= $row->track; ?>', '<?= $row->strand; ?>')" data-toggle="modal" data-target="#editModal">
                                                                    <i class="mdi mdi-pencil"></i>Edit
                                                                </button>

                                                                <a href="#" onclick="setDeleteUrl('<?= base_url('Settings/DeleteTrack_strand?trackID=' . $row->trackID); ?>')" data-toggle="modal" data-target="#confirmationModal" class="btn btn-danger waves-effect waves-light btn-sm">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editModalLabel">Update Track & Strand</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                </div>
                                <div class="modal-body">
                                    <form method="post" action="<?php echo base_url('Settings/updateTrack_strand'); ?>">
                                        <input type="hidden" id="editTrackID" name="trackID">
                                        <div class="form-row align-items-center">

                                            <div class="col-md-6 mb-3">
                                                <label for="editTrack">Year Level</label>
                                                <select name="yearLevel" id="yearLevel" class="form-control">
                                                    <option value="">Select Grade level</option>
                                                    <option value="Grade 11" <?= isset($data->yearLevel) && $data->yearLevel == "Grade 11" ? 'selected' : '' ?>>Grade 11</option>
                                                    <option value="Grade 12" <?= isset($data->yearLevel) && $data->yearLevel == "Grade 12" ? 'selected' : '' ?>>Grade 12</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="editStrand">Semester</label>
                                                <select name="sem" id="sem" class="form-control">
                                                    <option value="">Select Semester</option>
                                                    <option value="1st Sem" <?= isset($data->sem) && $data->sem == "First Semester" ? 'selected' : '' ?>>1st Sem</option>
                                                    <option value="2nd Sem" <?= isset($data->sem) && $data->sem == "Second Semester" ? 'selected' : '' ?>>2nd Sem</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="editTrack">Track</label>
                                                <input type="text" class="form-control" id="editTrack" name="track" required>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="editStrand">Strand</label>
                                                <input type="text" class="form-control" id="editStrand" name="strand" required>
                                            </div>
                                        </div>
                    ...
                    <script>
                        function editTrackStrand(trackID, track, strand, yearLevel, sem) {
                            ...
                            document.getElementById('yearLevel').value = yearLevel; // Populate yearLevel
                            document.getElementById('sem').value = sem; // Populate semester
                        }
                    </script>
                    ...
                    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="<?php echo base_url('Settings/Track_strand'); ?>">
                                        <div class="form-row align-items-center">
