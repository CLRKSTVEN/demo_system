                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <small>From: <?= $message->sent_by ?> | Sent on <?= date('F d, Y h:i A', strtotime($message->sent_at)) ?></small>
                        </div>
                        <div class="card-body">
                            <?= $message->message ?>
                    ...
                    <a href="<?= base_url('EmailBlast/inbox') ?>" class="btn btn-secondary mt-3">Back to Inbox</a>
