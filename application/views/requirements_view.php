                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-body table-responsive">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="m-t-0 header-title mb-2">Requirements for <?php echo $student->FullName ?? $student->StudentNumber; ?>
                                            </h4>
                                            <table class="table mb-0">
                                                ...
                                                <?php foreach ($requirements as $req): ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $req->date_submitted ? ($req->is_verified ? 'Verified' : 'Pending') : 'Not Submitted'; ?></td>
