                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-title-box">
                                <h4 class="page-title">STUDENTS' ACCOUNTING REPORTS <br />
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <td style="text-align:center">
                                                    <a href="<?= base_url(); ?>Page/studeaccount?id=<?php echo $row->StudentNumber; ?>"><button type="button" class="btn btn-info btn-xs">Account Summary</button></a>
                                                    <a href="<?= base_url(); ?>Page/state_Account_Accounting?id=<?php echo $row->StudentNumber; ?>"><button type="button" class="btn btn-success btn-xs">Statement of Accounts</button></a>
                                                </td>
                                            <?php
                                                echo "</tr>";
                                            }
