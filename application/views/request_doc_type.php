                ...
                <?php foreach ($types as $t): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('request/delete_document_type/' . $t->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this type?')">Delete</a>
                        </td>
                    </tr>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" name="is_active" <?= $t->is_active ? 'checked' : '' ?> class="form-check-input">
