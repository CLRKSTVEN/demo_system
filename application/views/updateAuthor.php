                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">UPDATE AUTHOR</h4>
						...
						<div class="row">
							...
							<!-- general form elements -->
 						        <div class="card-body"> 
									...
									<div class="form-row">
                                    <div class="col-lg-3">
													<label for="lastName">Author Number <span style="color:red">*</span></label>
													<input type="text" class="form-control" name="AuthorNum" required  value="<?php echo $row->AuthorNum; ?>"/>
												</div>	
										<div class="col-lg-3">
