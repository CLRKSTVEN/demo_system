                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body table-responsive">
                            <h4 class="header-title mb-4">Summary Counts Per District
                                <span>
                                </span>
                            </h4><br />
        ...
        <tbody>
                <?php foreach ($data as $row) : ?>
                    <tr>
                        <td><?= $row->district; ?></td>
                        <td>
    <a href="<?= base_url('Page/med_patient_list/Employee/' . rawurlencode($row->district)); ?>">
        <?= $row->employee_count; ?>
    </a>
</td>
<td>
    <a href="<?= base_url('Page/med_patient_list/Student/' . rawurlencode($row->district)); ?>">
        <?= $row->student_count; ?>
    </a>
</td>
                    </tr>
