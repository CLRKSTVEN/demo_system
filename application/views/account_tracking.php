                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-title-box">
                                <h4 class="page-title">ACCOUNT TRACKING <br />
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-body table-responsive">
                                    <!-- <h4 class="m-t-0 header-title mb-4"><b>Account Tracking</b>
                                        <br />
                                        <span class="badge badge-purple mb-3"><?php echo $this->session->userdata('semester'); ?> SY <?php echo $this->session->userdata('sy'); ?> </span>
                                    </h4> -->
                                    <?php
                                    if (!$data) {
                                        //the value is null
                                    ...
                                    ?>
                                        ...
                                        <table>
                                            <tr>
                                                <td>Student Name</td>
                                                <td>: <b> <?php echo $data[0]->FirstName . ' ' . $data[0]->MiddleName . ' ' . $data[0]->LastName; ?></b></td>
                                            </tr>
                                            <tr>
                                                <td>Course</td>
                                                <td>: <b><?php echo $data[0]->Course; ?></b></td>
                                            </tr>
                                        </table>
