...
<?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h4 class="page-title">
                                    <a href="<?= base_url(); ?>Library/add_other_settings">
                                    ...
                                    <div class="card-body">
                                        <div class="clearfix">
										  ...
										  <div class="float-left">
                                                <h5 style="text-transform:uppercase"><strong>LIBRARY INFORMATION</strong>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                         ...
                                                         <a href="<?= base_url('Library/update_other_settings?libID=' . $row->libID); ?>" 
                                                         class="btn btn-primary waves-effect waves-light btn-sm"><i class="mdi mdi-pencil"></i>Edit</a>
                                                        
                                                         <a href="#" class="btn btn-danger waves-effect waves-light btn-sm" data-toggle="modal" data-target="#confirmationModal" onclick="setDeleteUrl('<?= base_url('Library/Delete_other_settings?libID=' . $row->libID); ?>')">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?= base_url('Library/Delete_other_settings?libID=' . $row->libID); ?>'); ?>" class="btn btn-danger" onclick="deleteData()">Delete</a>
                    </div>
                </div>
            </div>
        </div>
