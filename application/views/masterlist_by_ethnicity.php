                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body table-responsive">
                                    ...
                                    <!-- Filter Form -->
                                    <form method="get" action="<?php echo site_url('Masterlist/studeEthnicity'); ?>" class="form-inline">
                                        <label for="ethnicity" class="mr-2 font-weight-bold">Select Ethnicity:</label>
                                        <select name="ethnicity" id="ethnicity" class="form-control w-60" onchange="this.form.submit()">
                                            <option value="">-- Select --</option>
                                            <?php foreach ($ethnicities as $e): ?>
                                                <option value="<?php echo $e->Ethnicity; ?>" <?php echo ($this->input->get('ethnicity') == $e->Ethnicity) ? 'selected' : ''; ?>>
                                                    <?php echo $e->Ethnicity; ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </form>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr class="bg-primary text-white text-center">
                                            <td colspan="7" class="font-weight-bold">MALE</td>
                                        </tr>
                                        ...
                                        <tr class="bg-pink text-white text-center">
                                            <td colspan="7" class="font-weight-bold">FEMALE</td>
                                        </tr>
                                        <?php $i = 1; ?>
                                        <tbody>
