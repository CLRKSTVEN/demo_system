...
<?php endif; ?> -->
    ...
    if ($deported_codes === null) {
        ...
        if (method_exists($CI->SubjectDeportmentModel, 'get_codes_by_yearlevel')) {
            ...
            $deported_codes = array_values(array_unique(array_map(static function ($r) {
    ...
    $attachGrade = function ($tplItem) use ($byCode, $byDesc, $norm) {
        ...
        if (!$g && $desc !== '') {
            ...
            foreach ($byDesc as $bd => $row) {
                if ($bd === '') continue;
                if (strpos($bd, $nd) !== false || strpos($nd, $bd) !== false) {
                    $g = $row;
                    break;
                }
            }
    ...
    $spec       = 'COMPUTER SYSTEM SERVICING NC II';
...
<?php endif; ?> -->
            ...
            <div class="shs-wrap">
                ...
                <table class="tb-shs">
                    ...
                    <tr>
                        <th colspan="5" class="titlebig">First Semester</th>
                    </tr>
                    <tr>
                        <th>Subjects</th>
                ...
                <table class="tb-shs">
                    ...
                    <tr>
                        <th colspan="5" class="titlebig">Second Semester</th>
                    </tr>
                    <tr>
                        <th>Subjects</th>
                        <th colspan="2">Quarter</th>
                    ...
                    <table class="nb" style="margin-bottom:6px">
                        <tr>
                            ...
                            <td style="width:25%">
                                ...
                                <div class="uline-lg"><?= htmlspecialchars($firstName, ENT_QUOTES, 'UTF-8'); ?></div>
                            </td>
                            <td style="width:25%">
                                <div class="small">(Middle Name)</div>
                                <div class="uline-lg"><?= htmlspecialchars($middleName, ENT_QUOTES, 'UTF-8'); ?></div>
                            </td>
                            <td>
                                <div class="small">(Last Name)</div>
                                <div class="uline-lg"><?= htmlspecialchars($lastName, ENT_QUOTES, 'UTF-8'); ?></div>
                            </td>
                        </tr>
                    </table>
