                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body table-responsive">
                                    <h4 class="m-t-0 header-title mb-4"><b>Faculty Load</b><br />
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <thead>
                                            <tr>
                                                <th>Subject Code <?= $this->session->userdata('IDNumber'); ?></th>
                                                <th>Description</th>
                                                <th>Strand</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($data as $row) {
                                                ...
                                                echo "<td style='text-align:left'>" . $row->strand . "</td>";
                                                echo "<td style='text-align: center'>" . $row->Section . "</td>";
                                                echo "<td style='text-align: center'>" . $row->SchedTime . "</td>";
                                            ...
                                            ?>
                                                <td style="text-align: center">
                                                    ...
                                                    <a href="<?= base_url(); ?>Instructor/subjectGrades?subjectcode=<?php echo $row->SubjectCode; ?>&description=<?php echo $row->Description; ?>&section=<?php echo $row->Section; ?>"><button type="button" class="btn btn-success btn-xs">View Grades</button></a>
