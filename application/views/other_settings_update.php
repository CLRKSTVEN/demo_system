...
<!-- Left Sidebar End -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">UPDATE PUBLISHER</h4>
        ...
        <div class="form-row mt-3">
            <div class="col-lg-6">
                ...
                <input type="number" class="form-control" name="no_days" value="<?php echo $row->no_days; ?>" required>
            </div>	

            <div class="col-lg-6">
                <label for="penalty">Penalty Amount <span style="color:red">*</span></label>
                <input type="number" class="form-control" name="penalty" step="0.01" value="<?php echo $row->penalty; ?>" required>
            </div>	
        </div>
    </div>
					</div>
