                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="page-title-box">
                                    <!-- <h4 class="page-title">Personnel List - <?php echo $data[0]->empPosition; ?></h4> -->
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <h4 class="m-t-0 header-title mb-4"><b>Personnel List - <?php echo $data[0]->empPosition; ?></b><br />
                                        ...
                                        <tbody>
										  ...
										  //echo "<td><a href='updateapplicants?id=".$row->id."'>Update</a></td>";
										  ?>
										  ...
										  <button type="button" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-remove"></i>View</button>
										  </a>
										  <?php
										  echo "</tr>";
