                ...
                <div id="<?= $collapseId; ?>" class="collapse" data-parent="#accordion">
                  <div class="card-body">
                    ...
                    <?php foreach ($semesterOrder as $semLabel): ?>
                      <?php if (!empty($semesters[$semLabel])): ?>
                        <?php foreach ($semesters[$semLabel] as $strandLabel => $subjects): ?>
                          <h6 class="mb-2">
                                    ...
                                    <td class="text-center">
                                      <button
                                        ...
                                        onclick="editSubject(
                                          ...
                                          '<?= htmlspecialchars($row->yearLevel, ENT_QUOTES, 'UTF-8'); ?>',   // pass REAL yearLevel
    ...
    <div class="modal-content">
      <form method="post" action="<?= base_url('Settings/Subjects'); ?>">
        ...
        <div class="modal-body">
          ...
          <div id="seniorHighDiv" style="display:none;">
            <div class="form-row">
              <div class="col-md-4 mb-3">
    ...
    <div class="modal-content">
      <form method="post" action="<?= base_url('Settings/updatesubjects'); ?>">
        ...
        <div class="modal-body">
          ...
          <div id="editseniorHighDiv" style="display:none;">
            <div class="form-row">
              <div class="col-md-4 mb-3">
...
(function ($) {
  ...
  window.editSubject = function (id, subjectCode, description, yearLevel, course, sem, strand) {
    $('#editid').val(id);
    ...
    // Single authoritative load for Year Levels with robust match
  ...
  $(function () {
    ...
    // jQuery UI Sortable -> send order as [{id, displayOrder}]
    $('.sortable').sortable({
      handle: '.drag-handle',
      update: function () {
        const $tb = $(this);
