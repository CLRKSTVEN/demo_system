							...
							<!-- general form elements -->
 						        <div class="card-body"> 
                                        <div class="col-lg-12">
													...
													<input type="text" class="form-control" name="Description" required  value="<?php echo $row->Description; ?>">
										</div>	
                                        ...
                                        <div class="col-lg-12">
													<label for="Responsible">Responsible. <span style="color:red">*</span></label>
													<input type="text" class="form-control" name="Responsible" required  value="<?php echo $row->Responsible; ?>">
										</div>

                                        <div class="col-lg-12">
													<label for="ExpenseDate">Expense Date. <span style="color:red">*</span></label>
													<input type="date" class="form-control" name="ExpenseDate" required  value="<?php echo $row->ExpenseDate; ?>">
										</div>

                                        <div class="col-lg-12">
    <label for="Category">Category. <span style="color:red">*</span></label>
    <select class="form-control" id="category" name="Category" required>
        <?php foreach ($data1 as $categoryItem) : ?>
            <option value="<?= $categoryItem->Category; ?>"
                <?php if ($row->Category == $categoryItem->Category) echo "selected"; ?>>
