            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?= form_open('Page/ta_form_edit', $att); ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                                                                ...
                                                                                <tr <?php echo (++$c%2 ? "" : "class='table-active'"); ?>>
                                                                                    ...
                                                                                    <select class="form-control" name="a<?=$sub_row->i_no; ?>" >
                                                                                        ...
                                                                                        <?php foreach($cat as $row){ ?>
                                                                                            <option <?php if($row == $sbmc->$count2){echo " selected ";} ?> value="<?= $row; ?>"><?= $row; ?></option>
                                                                                        <?php }?>
                                                                                    </select>
                                                                                    </td>
                                                                                    <td><textarea class="form-control" name="f<?=$sub_row->i_no; ?>" rows="2" id="example-textarea"><?= $sbmc->$count3; ?></textarea></td>
                                                                                </tr>
                                                                                <?php } ?>
                                    ...
                                    <input type="hidden" name="id" value="<?= $sbmc->id; ?>" /> 
                                    ...
                                    <div class="form-group text-left mb-0">
                                               ...
                                               <a href="<?= base_url(); ?>/Page/sbm_ta_final/<?= $sbmc->id; ?>" onclick="return confirm('Are you sure?')" class="btn btn-success waves-effect waves-light mr-1">Final</a>
                                        <?php } ?>
