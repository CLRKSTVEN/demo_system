            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?= form_open('Page/sbm_checklist_edit', $att); ?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="form-group text-left mb-0">
                                        <?php if($sbmc->stat == 0){?>
                                               ...
                                               <a href="<?= base_url(); ?>/Page/sbm_checklist_final/<?= $sbmc->id; ?>" onclick="return confirm('Are you sure?')" class="btn btn-success waves-effect waves-light mr-1">Final</a>
                                        <?php }  ?> 
