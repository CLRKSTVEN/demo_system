...
<?php endif; ?>
                                    ...
                                    <div class="card-body">
                                        <div class="clearfix">
										  ...
										  <div class="float-left">
                                                <h5 style="text-transform:uppercase"><strong>CIRCULATIONS - BORROW BOOKS</strong>
    ...
    <?php foreach ($data as $row) { 
        if ($row->status == 'Received') continue; // Skip received books
    ?>
        <tr>
            <td><?= $row->bookNo; ?></td>
            <td><?= $row->title; ?></td>
            ...
            <td style="text-align:center">
                ...
                <button class="btn btn-success btn-sm" data-toggle="modal" 
                    ...
                    onclick="setReceiveData('<?= $row->bookID; ?>', '<?= $row->bookNo; ?>', <?= $row->penalty_paid; ?>)">
