                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body table-responsive">
                                    <h4 class="m-t-0 header-title mb-4"><b>Students Aged <?= $age; ?></b><br />
                                    ...
                                    <a href="<?= site_url('Masterlist/exportAgeList/' . $this->uri->segment(3)); ?>" class="btn btn-success mb-3">Export to CSV File</a>
