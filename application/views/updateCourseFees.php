                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">UPDATE COURSE FEES</h4>
						...
						<div class="row">
							...
							<!-- general form elements -->
                                 ...
                                 <div class="col-lg-12">
													...
													<input type="text" class="form-control" name="YearLevel" required readonly  value="<?php echo $row->YearLevel; ?>">
										</div>

                                        <div class="col-lg-12">
													<label for="Course">Course. <span style="color:red">*</span></label>
													<input type="text" class="form-control" name="Course" required readonly value="<?php echo $row->Course; ?>">
										</div>


                                        <div class="col-lg-12">
													<label for="Description">Description. <span style="color:red">*</span></label>
													<input type="text" class="form-control" name="Description" required readonly value="<?php echo $row->Description; ?>">
										</div>	
