                                            ...
                                            <td><?= $row->Sub_category; ?></td>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <button type="button" class="btn btn-primary waves-effect waves-light btn-sm" 
                                                            onclick="editProgram('<?= $row->CatNo; ?>', '<?= $row->Category; ?>', '<?= $row->Sub_category; ?>')" 
                                                            data-toggle="modal" data-target="#editModal">
                                                        <i class="mdi mdi-pencil"></i>Edit
                                                    </button>

                                                    <a href="#" onclick="setDeleteUrl('<?= base_url('Settings/DeleteCategory?CatNo=' . $row->CatNo); ?>')" data-toggle="modal" data-target="#confirmationModal"  class="btn btn-danger waves-effect waves-light btn-sm">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo base_url('Settings/updateCategory'); ?>">
                   <!-- Hidden input for brandID -->
                        <input type="hidden" id="CatNo" name="CatNo">
...
<script>
function editProgram(CatNo, Category, Sub_category) {
    document.getElementById('CatNo').value = CatNo;  // Hidden input
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo base_url('Settings/category'); ?>">
                    <div class="form-row align-items-center">
                        <div class="col-md-12 mb-3">
                            <label for="CourseCode">Category</label>
                            <input type="text" class="form-control" id="Category" name="Category" required>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="CourseCode">Sub Category</label>
                            <input type="text" class="form-control" id="Sub_category" name="Sub_category">
                        </div>
