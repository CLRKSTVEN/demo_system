                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title">HR DASHBOARD <br /><span class="badge badge-purple mb-3">SY <?php echo $this->session->userdata('sy'); ?> <?php echo $this->session->userdata('semester'); ?></span></h4>
                                ...
                                <div class="card-body widget-style-2">
                                    <div class="media">
                                        <div class="media-body align-self-center">
                                            ...
                                            <p class="mb-0"><a href="<?= base_url(); ?>Page/employeeList">Peronnel Profile</a></p>
                                        </div>
