                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">
                                    <a href="<?= base_url(); ?>Library/Addauthor">
                                    ...
                                    <div class="card-body">
                                        <div class="clearfix">
										  ...
										  <div class="float-left">
                                                <h5 style="text-transform:uppercase"><strong>AUTHOR</strong>
												<!-- <br /><small><span class="badge badge-purple mb-3">LIBRARY MODULE</span></small> -->
												</h5>
                                            </div>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                         ...
                                                         <a href="<?= base_url('Library/updateAuthor?authorID=' . $row->authorID); ?>" 
                                                         class="btn btn-primary waves-effect waves-light btn-sm"><i class="mdi mdi-pencil"></i>Edit</a>
                                                        
                                                         <a href="#" class="btn btn-danger waves-effect waves-light btn-sm" data-toggle="modal" data-target="#confirmationModal" onclick="setDeleteUrl('<?= base_url('Library/Delete_Author?authorID=' . $row->authorID); ?>')">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?= base_url('Library/Delete_Author?authorID=' . $row->authorID); ?>" class="btn btn-danger" onclick="deleteData()">Delete</a>
                    </div>
                </div>
            </div>
        </div>
