											...
											<div class="row">
												<!-- <div class="col-lg-3">
													<div class="form-group">
														...
														<input type="text" name="StudentNumber" class="form-control" value="<?= isset($autoStudentNumber) ? $autoStudentNumber : '' ?>">
													</div>
												</div> -->
												<div class="col-lg-3">
													<div class="form-group">
											...
											<div class="row">
												...
												<div class="col-lg-6">
													<div class="form-group">
														...
														<select class="form-control select2" name="Elementary" required>
															<option disabled selected></option>
											...
											<div class="row">
												<div class="col-lg-8">
													<div class="form-group">
														...
														<input type="email" class="form-control" name="p_email" value="">
													</div>
												</div>
