                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">This Month's Birthday Celebrants</h4>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <h4 class="m-t-0 header-title mb-4"><b><?php echo date('F Y'); ?></b></h4>
													...
													<tbody>	
														  <?php
															...
															<td style="text-align:left;">
															  <i class="ion ion-md-contact"></i> <?php echo $row->StudeName; ?>
