                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><input required type="text" style="width:70%" class="text-center" name="PGrade[<?php echo $row->gradeID; ?>]" value="<?php echo $row->PGrade; ?>"></td>
                                                    <td class="text-center"><input required type="text" style="width:70%" class="text-center" name="MGrade[<?php echo $row->gradeID; ?>]" value="<?php echo $row->MGrade; ?>"></td>
                                                    <td class="text-center"><input required type="text" style="width:70%" class="text-center" name="PFinalGrade[<?php echo $row->gradeID; ?>]" value="<?php echo $row->PFinalGrade; ?>"></td>
                                                    <td class="text-center"><input required type="text" style="width:70%" class="text-center" name="FGrade[<?php echo $row->gradeID; ?>]" value="<?php echo $row->FGrade; ?>"></td>
