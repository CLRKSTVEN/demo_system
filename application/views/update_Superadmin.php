...
<body>
    ...
    <div class="card-body">
        ...
        <div class="row mt-3">
            <!-- Column 2 -->
            <div class="col-md-3">
                <label for="Registrar">Registrar (SHS)</label>
                <input type="text" class="form-control" name="RegistrarSHS" value="<?php echo $row->RegistrarSHS; ?>">
            </div>
            <div class="col-md-3">
                <label for="registrarPosition">Registrar (JHS)</label>
                <input type="text" class="form-control" name="RegistrarJHS" value="<?php echo $row->RegistrarJHS; ?>">
            </div>
            <div class="col-md-3">
                <label for="cashier">Guidance (SHS)</label>
                <input type="text" class="form-control" name="GuidanceSHS" value="<?php echo $row->GuidanceSHS; ?>">
            </div>

            <div class="col-md-3">
                <label for="cashier">Guidance (JHS)</label>
                <input type="text" class="form-control" name="GuidanceJHS" value="<?php echo $row->GuidanceJHS; ?>">
            </div>
        </div>

        <div class="row mt-3">
            <div class="col-md-4">
                <label for="cashierPosition">Property Custodian</label>
                <input type="text" class="form-control" name="PropertyCustodian" value="<?php echo $row->PropertyCustodian; ?>">
            </div>
            <div class="col-md-4">
                <label for="clerk">Finance Officer</label>
                <input type="text" class="form-control" name="financeOfficer" value="<?php echo $row->financeOfficer; ?>">
            </div>
            <div class="col-md-4">
                <label for="clerkPosition">Data base Name</label>
                <input type="text" class="form-control" name="DBName" value="<?php echo $row->DBName; ?>">
            </div>
        </div>
