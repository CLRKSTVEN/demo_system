        ...
        <div class="wrap">
            ...
            <table class="studProf">
                ...
                <tr>
                    ...
                    <td class="text-left border-bottom" colspan="5"><?= !empty($sem_stud->Track) ? $sem_stud->Track : ''; ?> <?= !empty($sem_stud->Qualification) ? $sem_stud->Qualification : ''; ?> </td>
                </tr>
                <tr>
            ...
            <!-- <table class="dr">
                <tr>
                    <th colspan="4" class="text-center">Documents and Requirments</th>
                </tr>
                <tr>
                    <td> <input type="checkbox" name="" id="" <?php if (!empty($req)) {
                                                                    if ($req->req1Stat == "") {
                                                                        echo " checked ";
                                                                    }
                                                                } ?>> </td>
                    <td>SF 9 (Original Report Card)</td>
                    <td><input type="checkbox" name="" id=""></td>
                    <td>Confirmation Certificate</td>
                </tr>
                <tr>
                    <td> <input type="checkbox" <?php if (!empty($req)) {
                                                    if ($req->req2Stat == "") {
                                                        echo " checked ";
                                                    }
                                                } ?> name="" id=""> </td>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="" id=""></td>
                    <td>National Career Assesment Exam (for SHS)</td>
                </tr>
                <tr>
                    <td> <input type="checkbox" <?php if (!empty($req)) {
                                                    if ($req->req4Stat == "") {
                    ...
                    <td><input type="checkbox" name="" id=""></td>
                    <td>Medical and Dental Health Record</td>
                </tr>
                <tr>
                    <td> <input type="checkbox" <?php if (!empty($req)) {
                                                    if ($req->req5Stat == "") {
                    ...
                    <td>First Communion Certificate</td>
                    <td></td>
                    <td></td>
                </tr>

            </table>
            <p class="dsp">Date: August 01, 2024</p> -->
