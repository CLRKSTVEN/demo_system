                                            ...
                                            <td><?= $row->office; ?></td>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <button type="button" class="btn btn-primary waves-effect waves-light btn-sm" 
                                                            onclick="editProgram('<?= $row->officeID; ?>', '<?= $row->office; ?>')" 
                                                            data-toggle="modal" data-target="#editModal">
                                                        <i class="mdi mdi-pencil"></i>Edit
                                                    </button>

                                                    <a href="#" onclick="setDeleteUrl('<?= base_url('Settings/DeleteOffice?officeID=' . $row->officeID); ?>')" data-toggle="modal" data-target="#confirmationModal"  class="btn btn-danger waves-effect waves-light btn-sm">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Update Office</h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <div class="modal-body">
                <form method="post" action="<?php echo base_url('Settings/updateOffice'); ?>">
                   <!-- Hidden input for brandID -->
                        <input type="hidden" id="officeID" name="officeID">

                        <!-- Text input for brandName -->
                        <div class="col-md-12 mb-3">
                            <label for="brandName">Office Name</label>
...
<script>
function editProgram(officeID, office) {
    document.getElementById('officeID').value = officeID;  // Hidden input
    document.getElementById('office').value = office;  // Brand Name input
}
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo base_url('Settings/office'); ?>">
                    <div class="form-row align-items-center">
                        <div class="col-md-12 mb-3">
                            <label for="CourseCode">Office Name</label>
                            <input type="text" class="form-control" id="brand" name="office" required>
                        </div>
